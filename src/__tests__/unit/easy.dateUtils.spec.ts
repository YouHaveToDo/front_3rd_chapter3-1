...
describe('dateUtils', () => {
  describe('getDaysInMonth', () => {
    ...
    it('2024년 13월은 2025년 1월에 대해 31일을 반환한다', () => {
      expect(getDaysInMonth(2024, 13)).toBe(31);
    });

    it('2024년 0월은 2024년 12월에 대해 31일을 반환한다', () => {
      expect(getDaysInMonth(2024, 13)).toBe(31);
    });

    it('2024년 -1월은 2024년 11월에 대해 30일을 반환한다', () => {
  ...
  describe('getWeekDates', () => {
    ...
    it('주의 시작(월요일)에 대해 올바른 주의 날짜들을 반환한다', () => {
      expect(getWeekDates(new Date('2024-11-04'))).toEqual([
        new Date('2024-11-03'),
        new Date('2024-11-04'),
        new Date('2024-11-05'),
        new Date('2024-11-06'),
  ...
  describe('formatWeek', () => {
    it('월의 중간(15일) 날짜에 대해 올바른 주 정보를 반환한다', () => {
  ...
  describe('formatDate', () => {
    it('날짜를 YYYY-MM-DD 형식으로 포맷팅한다', () => {
      expect(formatDate(new Date('2024-11-05'))).toBe('2024-11-05');
    });

    it('day 파라미터가 제공되면 해당 일자로 포맷팅한다', () => {
      expect(formatDate(new Date('2024-11-10'), 15)).toBe('2024-11-15');
    });

    it('월이 한 자리 수일 때 앞에 0을 붙여 포맷팅한다', () => {
      expect(formatDate(new Date('2024-06-10'))).toBe('2024-06-10');
    });

    it('일이 한 자리 수일 때 앞에 0을 붙여 포맷팅한다', () => {
      expect(formatDate(new Date('2024-06-05'))).toBe('2024-06-05');
    });
  });
});
